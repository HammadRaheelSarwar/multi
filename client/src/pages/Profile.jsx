        ...
        >
          ...
          <div className="relative grid gap-8 p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-10">
            <div className="space-y-5">
              <div className="inline-flex items-center gap-2 rounded-full border-2 border-blue-400/40 bg-gradient-to-r from-blue-600/30 to-indigo-600/30 px-4 py-1.5 text-xs font-extrabold uppercase tracking-[0.15em] text-blue-200 backdrop-blur-md shadow-lg shadow-blue-500/10">
                <Sparkles size={14} className="text-blue-400 animate-pulse" /> {user?.role === 'business_owner' ? '💼 Business Owner (Customer View)' : '👤 Customer Profile'}
              </div>
              <div>
              ...
              <form onSubmit={handleSaveProfile} className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-2">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-gradient-to-r from-blue-600 to-indigo-600 border border-blue-400/30 text-[10px] font-extrabold uppercase tracking-wider text-white rounded-full shadow-md shadow-blue-500/25">
