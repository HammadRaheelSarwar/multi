...
import { MapPin, Phone, MessageCircle, Globe, ShieldCheck, Star, Clock, X, Calendar } from 'lucide-react';
            ...
            <div className="flex flex-col gap-2 shrink-0 w-full sm:w-auto">
              ...
              {(!isAuthenticated || (user && user._id !== business.owner?._id)) && (
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 dark:text-gray-250 dark:bg-dark-700 dark:hover:bg-dark-600 rounded-xl transition-colors shadow-sm"
                >
